#
#  Be sure to run `pod spec lint UIDropDown.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Isaac Gongora"
  # s.authors            = { "Isaac Gongora" => "igongoracastano@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Isaac Gongora"
  ...
  s.source       = { :git => "https://github.com/igongora/UIDropDown.git", :tag => "1.0.0" }
